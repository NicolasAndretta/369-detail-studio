...
export function WhatsAppSticky() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      // Show button after 300px of scroll height
      setIsVisible(window.scrollY > 300);
    };

    window.addEventListener("scroll", handleScroll, { passive: true });
    handleScroll(); // Check scroll height initially
    ...
    <AnimatePresence>
      {isVisible && (
        ...
        >
          ...
          <span className="whatsapp-sticky__pulse" aria-hidden="true" />
          ...
          <svg
            ...
            viewBox="0 0 24 24"
            fill="currentColor"
            className="whatsapp-sticky__icon"
            aria-hidden="true"
          >
